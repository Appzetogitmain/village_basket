                ...
                <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-2xl p-6 border border-teal-200">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-3 text-sm">
                            ...
                            <span className="text-neutral-700">+91 78299 03973</span>
                        </div>
                        <div className="flex items-center gap-3 text-sm">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-teal-600 flex-shrink-0">
                            ...
                            <span className="text-neutral-700">Flat No. 252, Ground Floor, Mugabala, Near GHPS Mugabala, Bengaluru Rural, Karnataka - 562114</span>
                        </div>
                    </div>
                </div>
