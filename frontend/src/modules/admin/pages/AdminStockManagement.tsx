                  ...
                  {filteredProducts.map((product) => (
                    ...
                    >
                      ...
                      <div className="relative aspect-square bg-neutral-50 overflow-hidden border-b border-neutral-100 px-3 py-2">
                        ...
                        {/* Actions */}
                        <div className="absolute inset-x-0 bottom-2 flex justify-center gap-2 transition-all duration-300">
                          <button
                        ...
                        <div className="mt-auto flex items-end justify-between">
                          <div className="flex flex-col">
                            ...
                            <span className="font-bold text-neutral-900">
                              {"\u20B9"}{calculateProductPrice(product, undefined, "retail").displayPrice}
                            </span>
                          </div>
