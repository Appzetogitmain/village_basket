    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto px-3 py-2 sm:p-3 bg-neutral-50">
        <div className="bg-white rounded-lg shadow-sm border border-neutral-200 overflow-hidden">
          {/* Filters */}
          <div className="px-3 py-2 sm:p-3 border-b border-neutral-200 bg-neutral-50">
            <div className="grid grid-cols-1 md:grid-cols-4 gapx-3 py-2">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-1.5 text-[13px] border border-neutral-300 rounded focus:outline-none focus:ring-1 focus:ring-[#8B3D28] focus:border-[#8B3D28]"
                />
              </div>
              <div>
                <label className="block text-xs font-medium text-neutral-700 mb-1">
                ...
                <select
                  ...
                  className="w-full px-3 py-2 text-sm border border-neutral-300 rounded focus:outline-none focus:ring-2 focus:ring-[#8B3D28] focus:border-[#8B3D28] bg-white">
              ...
              <div className="flex items-end">
                <button
                  ...
                  className="w-full bg-[#A54B31] hover:opacity-90 text-white px-4 py-1.5 rounded text-[12px] font-black uppercase tracking-wider transition-all flex items-center justify-center gap-2 shadow-sm">
                  Export
                  <svg
                    width="14"
                    height="14"
          ...
          <div className="px-3 py-2 sm:p-3 border-b border-neutral-200">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-14 pr-3 py-1.5 bg-neutral-100 border-none rounded text-[13px] focus:ring-1 focus:ring-[#8B3D28]"
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-[#FAF7F2] text-[10px] font-black text-neutral-500 uppercase tracking-wider font-outfit border-b border-neutral-200">
                  <th
                  ...
                  <th className="px-3 py-2 border border-neutral-200">Ref Code</th>
                  <th
                    className="px-3 py-2 border border-neutral-200 cursor-pointer hover:bg-[#FAF7F2] transition-colors"
                    ...
                    <tr
                      ...
                      <td className="px-3 py-2 border border-neutral-200">
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            className="p-1.5 bg-[#8B3D28] hover:opacity-90 text-white rounded transition-colors"
                            title="Edit">
                            <svg
                              width="14"
                              height="14"
          ...
          <div className="px-3 py-2 border-t border-neutral-200 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-0">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className={`p-1.5 border border-[#A54B31] rounded ${currentPage === 1
                  ? "text-neutral-400 cursor-not-allowed bg-neutral-50 border-neutral-200"
                  : "text-[#A54B31] hover:bg-orange-50"
                  }`}>
                <svg
                  width="14"
                  height="14"
              ...
              <button className="px-3 py-1 border border-[#A54B31] bg-[#A54B31] text-white rounded font-black text-xs">
                {currentPage}
              </button>
              <button
                onClick={() =>
                ...
                className={`p-1.5 border border-[#A54B31] rounded ${currentPage === totalPages
                  ? "text-neutral-400 cursor-not-allowed bg-neutral-50 border-neutral-200"
                  : "text-[#A54B31] hover:bg-orange-50"
                  }`}>
                <svg
