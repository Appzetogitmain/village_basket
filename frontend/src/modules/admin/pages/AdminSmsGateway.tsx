    ...
    <div className="flex flex-col h-full">
      ...
      <div className="bg-white px-3 py-2.5 border-b border-neutral-200">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gapx-3 py-2">
          <div>
            <h1 className="text-lg sm:text-xl font-black text-neutral-900 font-outfit uppercase tracking-tight">SMS Gateway</h1>
          </div>
          <div className="text-[12px] font-bold text-neutral-500">
            <span className="text-[#8B3D28]">Home</span> / <span className="text-neutral-900">SMS Gateway</span>
          </div>
        </div>
      </div>
              ...
              <div className="px-3 py-2 sm:p-3 space-y-4">
                ...
                {Object.entries(gateway.fields).map(([fieldName, fieldValue]) => (
                  <div key={fieldName}>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 border border-neutral-300 rounded text-sm bg-neutral-50 text-neutral-700 focus:outline-none focus:ring-2 focus:ring-[#8B3D28] focus:border-[#8B3D28]"
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2.5 border border-neutral-300 rounded text-sm bg-white text-neutral-700 focus:outline-none focus:ring-2 focus:ring-[#8B3D28] focus:border-[#8B3D28]"
                  >
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="w-full bg-[#8B3D28] hover:opacity-90 text-white px-4 py-2.5 rounded font-medium transition-colors"
                  >
                    Update SMS Gateway
                  </button>
                </div>
