                                ...
                                <div key={withdrawal._id} className="village-card paper-texture organic-radius p-4 border-none shadow-sm">
                                    <div className="flex justify-between items-start mb-3">
                                        ...
                                        <span className={`px-2 py-0.5 rounded-lg text-[7px] font-black uppercase tracking-widest leading-none ${
                                            withdrawal.status === "Completed" ? "bg-[#4A7C59]/10 text-[#4A7C59]" : "bg-stone-100 text-stone-400"
                                        }`}>
                                            {withdrawal.status}
                                        </span>
                                    </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {(["Bank Transfer", "UPI"] as const).map(method => (
                                <button
                                    ...
                                    className={`py-4 rounded-2xl font-black text-[9px] uppercase tracking-widest border-2 transition-all active:scale-95 ${
