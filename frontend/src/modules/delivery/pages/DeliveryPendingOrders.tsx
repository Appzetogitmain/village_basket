...
export default function DeliveryPendingOrders() {
  ...
  const getStatusStyle = (status: string) => {
    ...
    if (s.includes('out') || s.includes('delivery') || s.includes('transit')) return 'text-[#4A7C59] bg-[#4A7C59]/10 ring-1 ring-[#4A7C59]/20';
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    <p className="text-stone-300 text-[8px] font-black uppercase tracking-widest mb-1">ACTIVE TX-ID</p>
