            ...
            <div className="bg-white/90 backdrop-blur-md border-white/20 border-b border-neutral-200 px-4 sm:px-6 py-4">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    ...
                    <div className="flex items-center gap-2 text-sm">
                        <Link to="/seller" className="text-[#8B3D28] hover:text-[#723221] font-medium">
                            Home
                        </Link>
                    ...
                    <div className="p-4 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 border-b border-neutral-100">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 flex-1">
                            <div className="flex flex-col sm:flex-row items-center gap-2">
                                <div className="flex items-center gap-2">
                                    ...
                                    <input
                                        ...
                                        className="px-3 py-1.5 bg-white border border-neutral-300 rounded text-sm focus:ring-1 focus:ring-[#8B3D28] focus:outline-none cursor-pointer hover:border-neutral-400 transition-colors"
                                    />
                                </div>
                                <div className="flex items-center gap-2">
                                ...
                                <button
                                    ...
                                    className="px-3 py-1.5 bg-neutral-700 hover:bg-neutral-800 text-white text-xs font-bold uppercase rounded transition-colors ml-1"
                                >
                                    Clear
                                </button>
                            </div>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <select
                                    ...
                                    className="px-3 py-2 bg-white/90 backdrop-blur-md border-white/20 border border-neutral-300 rounded text-sm focus:ring-1 focus:ring-[#8B3D28] focus:outline-none cursor-pointer"
                                >
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                            ...
                            <button
                                ...
                                className="bg-[#8B3D28] hover:bg-[#723221] text-white px-3 py-1.5 rounded text-sm font-medium flex items-center gap-1 transition-colors"
                            >
                            ...
                            <div className="relative">
                                ...
                                <input
                                    type="text"
                                    className="pl-14 pr-3 py-1.5 bg-neutral-100 border-none rounded text-sm focus:ring-1 focus:ring-[#8B3D28] w-full sm:w-48"
                                    value={searchTerm}
