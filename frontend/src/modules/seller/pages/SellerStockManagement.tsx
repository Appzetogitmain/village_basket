                                    ...
                                    <td className="p-4 align-middle border border-neutral-200">
                                        <div className="flex items-center gap-2">
                                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${item.stock === 0
                                                ...
                                                : 'bg-[#FAF7F2] text-[#8B3D28] border border-[#8B3D28]/10'
                                                }`}>
                                                {item.stock}
                                            </span>
                                        </div>
                                    ...
                                    <td className="p-4 align-middle border border-neutral-200">
                                        <div className="flex items-center gap-2">
                                            <input
                                                ...
                                                className="w-20 px-2 py-1 border border-neutral-300 rounded text-sm focus:ring-1 focus:ring-[#8B3D28] outline-none"
                                                onKeyDown={(e) => {
                                                    if (e.key === 'Enter') {
                                            ...
                                            <button
                                                ...
                                                className="p-1.5 bg-[#8B3D28] text-white rounded hover:bg-[#723221] transition-colors disabled:bg-neutral-300"
                                                title="Update Stock"
                                            >
