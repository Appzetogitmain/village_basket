            ...
            <div className="bg-white/90 backdrop-blur-md border-white/20 rounded-lg shadow-sm border border-neutral-200 flex-1 flex flex-col">
                                ...
                                <tr>
                                    <td colSpan={4} className="p-8 text-center text-neutral-400 border border-neutral-200">
                                        <div className="flex flex-col items-center gap-2">
                                            <div className="w-6 h-6 border-2 border-[#8B3D28] border-t-transparent rounded-full animate-spin" />
                ...
                <div className="px-4 sm:px-6 py-3 border-t border-neutral-200 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-0">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            className="px-3 py-1.5 border border-[#8B3D28] bg-[#8B3D28] text-white rounded font-medium text-sm"
                        >
                            {currentPage}
                        </button>
                        <button
