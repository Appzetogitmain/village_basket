...
export default function DashboardCard({ icon, title, value, accentColor }: DashboardCardProps) {
  return (
    <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-sm border border-white p-2.5 sm:p-3 md:p-4 hover:shadow-md transition-all overflow-hidden relative">
