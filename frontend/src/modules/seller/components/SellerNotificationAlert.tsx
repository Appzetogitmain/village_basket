  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black bg-opacity-60 backdrop-blur-sm">
      ...
      <div className="bg-white/90 backdrop-blur-md border-white/20 rounded-xl shadow-2xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in duration-300">
        {/* Header */}
        <div className={`px-6 py-4 flex items-center justify-between ${notification.type === 'NEW_ORDER' ? 'bg-[#8B3D28]' : 'bg-[#723221]'} text-white`}>
        ...
        <div className="p-6 max-h-[70vh] overflow-y-auto">
          ...
          <div className="mb-6 bg-white/40 p-3 rounded-lg flex items-center gap-4">
            ...
            <input
              ...
              className="flex-1 accent-[#8B3D28]"
            />
          </div>
          ...
          {notification.type === 'NEW_ORDER' ? (
             <div className="flex gap-4">
               <button
                 ...
                 disabled={loading}
                 className="flex-1 py-4 rounded-xl font-bold text-white shadow-lg bg-[#8B3D28] hover:bg-[#723221] transition-transform active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
               >
