        ...
        try {
            ...
            if (io) {
                ...
                if (savedOrder) {
                    ...
                    await notifySellersOfOrderUpdate(io, orderAny, 'NEW_ORDER');
                    ...
                    try {
                        ...
                        for (const sellerId of sellerIdsInOrder) {
                            await sendNewOrderNotification(sellerId as string, orderAny._id.toString(), orderAny.orderNumber, orderAny.total);
                        }
                    } catch (pushErr) {
